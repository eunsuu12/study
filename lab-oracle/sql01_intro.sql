...
-- dual: 오라클 데이터베이스에서
--      select 문장의 문법에 맞추기 위해서 만든 가상의 테이블 이름.
select sysdate from dual;

-- 테이블 구조를 확인하기 위한 "오라클" 명령어:
...
--      사용 예: number(2)- 2자리 정수, 
--              number(7,2)- 소수점 2자리까지 표현 가능한 실수.
-- (2) varchar, varchar2: 가변 길이 문자열.
--      사용 예: varchar2(10), varchar2(10byte)
--              - 최대 10bytes까지 저장할 수 있는 문자열.
--      사용 예: varchar2(10 char)
--              - 최대 10글자까지 저장할 수 있는 문자열.
