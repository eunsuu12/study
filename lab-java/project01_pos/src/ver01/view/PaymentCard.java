...
public class PaymentCard extends JFrame{
    
    @FunctionalInterface
    public interface onPaymentCardListener{
        void onpCardNotify(String pCard);
    }
    private onPaymentCardListener listener;
     ...
     */
    public static void newPaymentCard(Component parent, onPaymentCardListener listener) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    PaymentCard window = new PaymentCard(parent, listener);
     ...
     */
    public PaymentCard(Component parent, onPaymentCardListener listener) {
    ...
    private void initialize() {
        ...
        btnOk.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                pCard= textField.getText();
                listener.onpCardNotify(pCard);
                frame.dispose();
            }
        });
